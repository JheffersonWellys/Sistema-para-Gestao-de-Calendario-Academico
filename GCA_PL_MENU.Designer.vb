...
Partial Public NotInheritable Class GCA_PL_MENU
    ...
    Public Sub New(ByVal factory As Global.Microsoft.Office.Tools.Excel.Factory, ByVal serviceProvider As Global.System.IServiceProvider)
        MyBase.New(factory, serviceProvider, "GCA_PL_MENU", "GCA_PL_MENU")
    End Sub
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _GCA_PL_MENU As GCA_PL_MENU
    
    Friend Shared Property GCA_PL_MENU() As GCA_PL_MENU
        Get
            Return _GCA_PL_MENU
        End Get
        Set
            If (_GCA_PL_MENU Is Nothing) Then
                _GCA_PL_MENU = value
            Else
